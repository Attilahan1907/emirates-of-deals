      ...
      <div className="glass rounded-2xl p-6 max-w-md w-full border border-white/10">
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-white">Benachrichtigungs-Einstellungen</h3>
          </div>
          ...
          <button
            ...
            className={`mt-3 flex items-center gap-2 text-xs px-3 py-1.5 rounded-lg border transition-all disabled:opacity-40 disabled:cursor-not-allowed ${
              testState === 'success'
                ...
                : 'bg-white/5 border-white/15 text-white/50 hover:text-white/70 hover:bg-white/10'
            }`}
          >
