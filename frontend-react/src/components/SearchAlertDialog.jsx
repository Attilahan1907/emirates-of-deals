      ...
      <div className="glass rounded-2xl p-6 max-w-md w-full border border-white/10">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-bold text-white">Suchalarm einrichten</h3>
          </div>
        ...
        <div className="mb-4 p-3 bg-white/5 rounded-lg">
          <p className="text-xs text-white/50 mb-1">Suche</p>
          <p className="text-sm text-white/90 font-medium">"{query}"</p>
          <p className="text-xs text-white/40 mt-1">Du wirst benachrichtigt wenn eine neue Anzeige erscheint</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="z.B. 300"
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2 text-white placeholder-white/30 focus:outline-none focus:border-neon-cyan/50"
              required
            />
          ...
          <div className="flex gap-3 pt-2">
            <button type="button" onClick={handleClose}
              className="flex-1 py-2 px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white/70 transition-all">
              Abbrechen
            </button>
            <button type="submit"
